  ...
  return (
    <div className={`flex flex-col min-h-screen ${darkMode ? "dark" : ""}`}>
      ...
      <main className="flex-1">
        ...
        <section className="w-full py-20 md:py-32 bg-secondary/10" id="testimonials">
        ...
        <section className="w-full py-20 md:py-32 bg-secondary/10" id="analytics">
          <div className="container mx-auto px-4 md:px-6">
                ...
                <Card key={plan.name} className={`flex flex-col justify-between ${index === 1 ? 'border-primary shadow-lg scale-105' : ''}`}>
                  ...
                  <CardContent>
                    <Button className="w-full" onClick={openTallyForm}>
                      {index === 2 ? 'Свзаться с отдеом продаж' : 'Начать'}
                    </Button>
                  </CardContent>
                </Card>
              ))}
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <Accordion type="single" collapsible className="w-full max-w-3xl mx-auto">
              ...
              <AccordionItem value="item-4">
                ...
                Наша команда эксп��ртов готова помочь вам получить максимальную выгоду от нашей платформы и ответить на любые вопросы или проблемы, которые вы можете иметь.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </div>
